...
export const getExamsByTeacherId = async (
    ...
    try {
        const res = await axios.get(
            `http://localhost:8001/exams?teacher_id=${teacherId}`,
        );
        return res.data;
    } catch (error: unknown) {
        console.error(error);
...
export const getExamsByCourseId = async (
    ...
    try {
        const res = await axios.get(
            `http://localhost:8001/exams?course_id=${courseId}`,
        );
        return res.data;
    } catch (error: unknown) {
        console.error(error);
...
export const getExamById = async (
    ...
    try {
        const res = await axios.get(`http://localhost:8001/exams/${examId}`);
        return res.data;
    } catch (error: unknown) {
        console.error(error);
        return null;
...
): Promise<EditExamFormType | null> => {
    try {
        const res = await axios.patch(
            `http://localhost:8001/exams/${id}`,
            data,
        );
        return res.data;
    } catch (error: unknown) {
...
export const createExam = async (exam: Exam): Promise<Exam | null> => {
    try {
        const res = await axios.post("http://localhost:8001/exams", exam);
        return res.data;
    } catch (error: unknown) {
        console.error(error);
        return null;
...
export const deleteExamById = async (
    ...
    try {
        await axios.delete(`http://localhost:8001/exams/${examId}`);
        return true;
    } catch (error: unknown) {
        console.error(error);
        return false;
...
export const addQuestionToExam = async (
    ...
    try {
        ...
        await axios.patch(`http://localhost:8001/exams/${examId}`, {
