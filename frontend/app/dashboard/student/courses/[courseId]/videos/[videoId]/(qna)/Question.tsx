...
const Question = ({
    ...
    if (isEditing) {
        return (
            <div className="flex flex-col gap-4 rounded-2xl border bg-black/50 p-6 shadow-lg">
                <Textarea
                    value={editedText}
...
const RepliesForm = ({
    ...
    if (reply.answer_text === "")
        return <p className="p-lead text-center">No reply yet</p>;

    return (
        <div className="mt-4 flex flex-col gap-4 rounded-2xl border bg-gray-800 p-4">
