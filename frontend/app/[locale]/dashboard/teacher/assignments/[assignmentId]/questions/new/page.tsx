...
import { addQuestionToAssignment } from "@/lib/api/assignment";
...
const NewQuestionPage = () => {
    ...
    const t = useTranslations("TEACHER_DASHBOARD.ASSIGNMENTS.QUESTIONS.NEW_QUESTION");
    ...
    const onSubmit: SubmitHandler<QuestionFormData> = async (data) => {
        try {
            ...
            const res = await addQuestionToAssignment(
                assignmentId,
                questionData,
            );
            ...
            if (res) {
                ...
                router.push(
                    `/dashboard/teacher/assignments/${assignmentId}/questions`,
                );
            } else {
    ...
    return (
        <section>
            <header className="mb-8 flex flex-col sm:flex-row max-sm:gap-6 items-center justify-between">
                <div>
                ...
                <Button asChild variant="outline">
                    <Link
                        href={`/dashboard/teacher/assignments/${assignmentId}/questions`}
                    >
            ...
            <div className="bg-card rounded-lg border p-6 shadow-sm">
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    {questionType === "essay" && (
                        <div>
                            <Label htmlFor="model_answer">{t("label4_alt")}</Label>
                            <Textarea
                                id="model_answer"
