...
export default function EditQuestionPage() {
    ...
    const t = useTranslations("TEACHER_DASHBOARD.ASSIGNMENTS.QUESTIONS.EDIT_QUESTION");
    ...
    useEffect(() => {
        const loadQuestion = async () => {
            try {
                ...
                if (
                    ...
                    assignment.questions[Number(questionIndex)]
                ) {
                    const question =
                        assignment.questions[Number(questionIndex)];
        ...
        loadQuestion();
    }, [assignmentId, questionIndex, setValue, router, toast]);

    const onSubmit: SubmitHandler<QuestionFormData> = async (data) => {
        try {
            setIsSubmitting(true);
            const updatedQuestion = await updateQuestionInAssignment(
                assignmentId,
